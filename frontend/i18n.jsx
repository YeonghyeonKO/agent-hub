...
const I18N = {
  ko: {
    ...
    deploy_project_new_opt: '+ 새 프로젝트 만들기…',
    deploy_project_new_ph: '새 프로젝트 이름',
    deploy_project_none_hint: '프로젝트가 없어 입력한 이름으로 새로 만들어요.',
    ...
    deploy_ep_url_fixed: '주소를 자동으로 보정했어요',
    deploy_ep_url_autofix: '자동 보정',
    deploy_ep_url_clear: '지우기',
    deploy_ep_edit: '수정',
    deploy_ep_apikey_keep: '변경하려면 입력 (비워두면 기존 키 유지)',
    ...
    flow_tested: '동작 확인:',
    flow_std_compat: '사내 표준(1.9.0) 호환',
  ...
  en: {
    ...
    deploy_project_new_opt: '+ Create new project…',
    deploy_project_new_ph: 'New project name',
    deploy_project_none_hint: 'No projects yet — a new one will be created with this name.',
    ...
    deploy_ep_url_fixed: 'Adjusted the URL for you',
    deploy_ep_url_autofix: 'Auto-fix',
    deploy_ep_url_clear: 'Clear',
    deploy_ep_edit: 'Edit',
    deploy_ep_apikey_keep: 'Enter to change (leave blank to keep current key)',
    ...
    flow_tested: 'Tested:',
    flow_std_compat: 'Internal standard (1.9.0) compatible',
