...
const I18N = {
  ko: {
    ...
    // Deploy (Langflow)
    deploy_btn: '배포',
    deploy_title: 'Langflow에 배포',
    deploy_target_ep: '배포 대상 엔드포인트',
    deploy_loading: '불러오는 중…',
    deploy_no_ep: '등록된 Langflow 엔드포인트가 없습니다.',
    ...
    deploy_open_langflow: 'Langflow에서 열기',
    deploy_footer_flow: 'Flow를 새로 생성합니다',
    deploy_footer_comp: '컴포넌트를 Flow에 배포합니다',
    deploy_deploying: '배포 중…',
    deploy_err_generic: '배포에 실패했습니다.',
    deploy_err_502: '배포 대상 Langflow에서 오류가 발생했습니다.',
    deploy_status_ok: '정상',
    deploy_status_error: '실패',
    deploy_status_testing: '확인 중',
    deploy_status_unknown: '미확인',
    deploy_ep_name: '별칭',
    deploy_ep_name_ph: '예: 내 로컬 Langflow',
    deploy_ep_url: 'Langflow 주소 (Base URL)',
    deploy_ep_url_ph: 'https://langflow.mycorp 또는 http://localhost:7860',
    deploy_ep_apikey_opt: '(선택)',
  ...
  en: {
    ...
    // Deploy (Langflow)
    deploy_btn: 'Deploy',
    deploy_title: 'Deploy to Langflow',
    deploy_target_ep: 'Target endpoint',
    deploy_loading: 'Loading…',
    deploy_no_ep: 'No Langflow endpoints registered.',
    ...
    deploy_open_langflow: 'Open in Langflow',
    ...
    deploy_err_502: 'The target Langflow returned an error.',
    deploy_status_ok: 'OK',
    deploy_status_error: 'Failed',
    deploy_status_testing: 'Testing',
    deploy_status_unknown: 'Unknown',
    deploy_ep_name: 'Alias',
    deploy_ep_name_ph: 'e.g. My local Langflow',
    deploy_ep_url: 'Langflow URL (Base URL)',
    deploy_ep_url_ph: 'https://langflow.mycorp or http://localhost:7860',
    deploy_ep_apikey_opt: '(optional)',
