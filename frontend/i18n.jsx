...
const I18N = {
  ko: {
    ...
    admin_dashboard: '관리자 대시보드', admin_home: '홈',
    ...
    settings_formula: '랭킹 점수 공식', settings_formula_desc: '매일 오전 9시 갱신',
  ...
  en: {
    ...
    admin_dashboard: 'Admin Dashboard', admin_home: 'Home',
    ...
    settings_formula: 'Ranking Score Formula', settings_formula_desc: 'Refreshed daily at 9 AM',
